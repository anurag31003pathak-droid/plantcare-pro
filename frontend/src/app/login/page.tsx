        ...
        >
            <div className="bg-white/40 backdrop-blur-2xl border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.05)] rounded-3xl p-8 transition-all hover:bg-white/50">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-600 mt-2">Log in to your PlantCare Pro account.</p>
                </div>
                ...
                <div className="mt-8 text-center text-sm text-slate-600">
                    ...
                    <button onClick={() => router.push('/signup')} className="text-emerald-600 font-semibold hover:underline">
                        Register here
                    </button>
                </div>
            </div>
